...
const (
	...
	AuthService_AssignRoleToUser_FullMethodName = "/auth.v1.AuthService/AssignRoleToUser"
...
func (c *authServiceClient) AssignRoleToUser(ctx context.Context, in *AssignRoleRequest, opts ...grpc.CallOption) (*AssignRoleResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) AssignRoleToUser(context.Context, *AssignRoleRequest) (*AssignRoleResponse, error) {
...
func _AuthService_AssignRoleToUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).AssignRoleToUser(ctx, req.(*AssignRoleRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "auth-microservice/pb/v1/auth.proto",
}
